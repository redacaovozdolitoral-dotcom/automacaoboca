...
def criar_imagem_post(url_imagem, titulo_post, url_logo):
    ...
    try:
        ...
        fonte_arroba = ImageFont.truetype("Roboto-Black.ttf", 40)
        ...
        box_vermelho_coords = [(30, 600), (IMG_WIDTH - 40, IMG_HEIGHT - 40)]
        ...
        box_branco_coords = [(40, 650), (IMG_WIDTH - 50, IMG_HEIGHT - 50)]
...
def webhook_receiver():
    ...
    try:
        ...
        url_logo = "https://jornalvozdolitoral.com/wp-content/uploads/2025/11/logo_of_boca.png"
